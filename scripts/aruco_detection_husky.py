...
class ArucoDetector(Node):
    def __init__(self):
        ...
        # ROS 2 Publisher (Stop/Go Signal)
        self.status_publisher = self.create_publisher(String, "/aruco_status", 10)
    ...
    def publish_status(self, status):
        """Publish STOP/GO message to /aruco_status topic"""
        msg = String()
        msg.data = status
